---
name: design-it
description: "Use when a requirement or spec must become one self-contained HTML design document in a fixed house style (目录、SVG 图、决策面板、代码索引). Reuse for 需求/设计文档 that must look identical every time."
---
