---
name: understand
description: "Turn this session's changes into a two-column review page: file tree, syntax-highlighted diff, per-segment 相关单位需求 / 代码解释. Use for /understand, 解释新生成的代码, 看看这次变更, review 这次改动."
metadata:
  version: 1.0.0
---
